          ...
          >
            ...
            <div className="relative flex justify-center">
              <motion.div
                ...
                animate={{ opacity: [0, 0.95, 0], scale: [0.7, 1.18, 1.48] }}
                transition={{ delay: 0.32, duration: 0.8, ease: 'easeOut' }}
              />
              <motion.div
                initial={{ scale: 0, opacity: 0 }}
                animate={{ scale: [0, 1.24, 1], opacity: [0, 1, 1] }}
                transition={{ duration: 0.55, times: [0, 0.68, 1], ease: 'easeOut' }}
              >
            ...
            <motion.p
              ...
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.74, duration: 0.25, ease: 'easeOut' }}
            >
