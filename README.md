...
- The current app now includes the full progression ceremony loop, the Halo 3 service-record visual treatment, a single-scroll service-record sheet with an in-flow full rank table, the six-tier Tour shield progression from Base through Diamond, automatic return-home after resolved log flows, a visual-first home dashboard with a dominant Global Rank hero, compact status rails, tile-based track cards, and install-aware PWA surfaces for browser prompt installs plus iPhone add-to-home-screen guidance. The remaining work is the production install/standalone release pass in [docs/release-checklist.md](/C:/Users/rpmmi/Documents/spartan/docs/release-checklist.md) and [docs/production-phone-deploy.md](/C:/Users/rpmmi/Documents/spartan/docs/production-phone-deploy.md), especially real-device install validation, standalone launch QA, and offline shell verification from installed surfaces.
...
- Playwright mobile smoke coverage stays green for auth, home, log, rank-up, Tour, and offline flows
